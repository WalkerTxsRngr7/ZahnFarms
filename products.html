...
<body>
  ...
  <h1 class="slogan">Short about us here.... Beef Chicken Eggs</h1>

  <!--* Category boxes-->
  <!-- TODO Style -->
  <div class="uk-grid-small uk-child-width-1-4@s uk-flex-center uk-text-center" uk-grid>
    <!-- TODO Created dynamically from database -->
    <a href="product.html"><!--? Put class="uk-flex-last" for out of season items -->
      <div class="uk-card uk-card-default">    
        <div class="uk-card-media-top">
          <img src="images/beef.jpg" alt="">
        </div>
        <div class="uk-overlay uk-overlay-primary uk-position-bottom">
          <p class="card-name">Beef</p>
          <p class="card-price">($3/lb)</p>
        </div>
      </div>
    </a>
    <a href="product.html">
